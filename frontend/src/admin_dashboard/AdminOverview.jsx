        ...
        {stats.map((stat, idx) => (
          ...
          >
            ...
            <div className="z-10 relative flex justify-between items-end">
              <div>
                <h3 className="mb-1 font-medium text-slate-500 text-sm">
                  {stat.title}
                </h3>
                <p className="font-bold text-slate-900 text-3xl tracking-tight">
                  {stat.value}
                </p>
              </div>
              <span
                className={`text-xs font-semibold px-2 py-1 rounded-md ${stat.bg}`}
              >
                {stat.label}
              </span>
            </div>
